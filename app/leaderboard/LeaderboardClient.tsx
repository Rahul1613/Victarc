...
export default function LeaderboardClient({
  ...
  const reigningMonarch = (leaderboard[0] || initialLeaderboard[0]) ? {
    ...
    instagram_handle: (leaderboard[0] || initialLeaderboard[0]).instagram_handle,
  } : {
            ...
            <div className="relative z-40 w-full pb-12 px-4 flex justify-center">
              {showBanner && (
                ...
                >
                  ...
                  {reigningMonarch.instagram_handle && (
                    <div className="mt-3 flex justify-center">
                      <a
                        href={`https://instagram.com/${reigningMonarch.instagram_handle}`}
                        target="_blank"
                        rel="noopener noreferrer"
                        className="inline-flex items-center gap-1.5 px-3.5 py-1 bg-gradient-to-r from-pink-600 via-purple-600 to-indigo-600 hover:from-pink-500 hover:via-purple-500 hover:to-indigo-500 text-white rounded-full font-rajdhani font-black text-[10px] md:text-xs uppercase tracking-widest transition-all duration-300 shadow-lg hover:scale-105 border border-white/10"
                      >
                        ...
                        Follow @{reigningMonarch.instagram_handle}
                      </a>
                    </div>
                  )}
